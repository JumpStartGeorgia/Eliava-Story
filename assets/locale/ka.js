ka =
{
  ...
  "drag_or_use": "ეს არის უნიკალური ბაზრის პანორამული ნახატი, სადაც საბჭოთა დროინდელ ხელსაწყოებს ყიდიან  საქართველოში, თბილისში.<br/> <br/> დააჭირეთ ნარინჯისფერ ფიგურებს დახლის მფლობელების ვიდეო ისტორიების სანახავად, ასევე გადადით, გადაახვიეთ და მიაახლოვეთ ისრის მეშვეობით.",
  "share": "გააზიარე",
  "en": "English",
  "ge": "ქართული",
  "ru": "Русский",
  ...
  "about": {
    ...
    "text": "<p>თქვენ ვერ იპოვით მას თბილისის შესახებ ბუკლეტებში და ის, საკმაოდ შორსაა,  ტურისტული ბილიკებიდან, მაგრამ როცა პირველად ჩამოვედი საქართველოს დედაქალაქში და  ღია ცის ქვეშ გაშლილ ტექნიკის ბაზარზე მოვხვდი, გავიფიქრე: “მე ეს ადგილი უნდა დავხატო”.</p> <p>მე აქ პირველად მოვედი , როგორც მომხმარებელი. სახლში ხელსაქმისთვის რამდენიმე ნივთი უნდა შემეძინა, მაგრამ საბჭოთა წარსულის “მთავარ დეპოში” აღმოვჩნდი და ჩემში მცხოვრები მხატვარი მოიხიბლა.</p> <p>ახალი მაღაზიების უკან, დიდი ლაბირინთი იმალება, მჭიდროდ შეფუთული საბჭოთა ეპოქის ძრავებით, ელექტრო მოწყობილობებითა და მძიმე ინსტრუმენტებით. ბაზარი ცნობილი როგორც „ელიავა” (მიმდებარე ქუჩის მსგავსად), საქართველოსთვის მძიმე წლებში გაჩნდა.   1991 წელს, მას შემდეგ რაც ქვეყანამ დამოუკიდებლობა მოიპოვა. აქ ასობით დახლია, რომლებზეც რუსული სახრახნისებით და ჭანჭიკებით დაწყებული, სიჩქარის გადაცემათა კოლოფით და ძრავებით დასრულებული ყველაფერია. ისინი ერთ დროს საბჭოთა მეტროს ესკალატორებს ამუშავებდნენ. მე გადავწყვიტე,  ყოველივე ამის ისტორია ნახატად მექცია.</p> <p>ბაზრის, ერთ-ერთ ნაწილზე გადავწყვიტე ფოკუსირება და 360 გრადუსიანი პანორამის დასახატად დავჯექი, რომელიც ყველაფერს აღწერდა მხედველობის არეალში. დაახლოებით ოთხთვიანი მუშაობის, ერთსა და იმავე  ადგილზე დგომის შედეგად,  4 მეტრიანი მელნის ნახატი გამომივიდა.</p> <p>მე დავიწყე <a href='#' class='to-character' data-id='6'>ვაჟა ჯამაგიძით</a>, მრავალფეროვანი ლითონის ხელსაწყოებითა და განახლებული აბაზანის ონკანებით, რომლებიც რუსეთშია დამზადებული  და რომლებსაც ის ორ პატარა სკამზე ყიდის. ის აქ 20 წელზე მეტია მუშაობს, თუმცა მისი მკლავები და მხრები სხვა ცხოვრებაზე გვიყვებიან.  როცა ის საბჭოთა არმიის ჩემპიონი იყო ჭიდაობაში. როდესაც ის და დახლების სხვა მეპატრონეები გავიცანი, ჩემში ჯურნალისტმა, ამ ადამიანებში უფრო ღრმა ამბავი დაინახა.</p> <p>ეს არის თავისუფალი ბაზარი, სადაც კომუნისტურ წარულს ყიდიან და ბევრს უნდა, რომ კომუნიზმი აწმყო იყოს. ეს ადგილი გვაჩვენებს საქართველოს გარდასახვასა და შესაძლებლობას დააკვირდე ძიებას, როგორ ცდილობს ქვეყანა თავისი პოსტ-საბჭოური იდენტობის პოვნას, აღმოსავლეთსა და დასავლეთს შორის.</p> <p>ნახატზე ასახული ყველა პიროვნება საბჭოთა საქართველოში დაიბადა და ზოგიერთს მოუწიე მორგებოდა იმ სწრაფ ცვლილებებს, რომლებსაც მისი ქვეყანა განიცდიდა. მიუხედავად იმისა, რომ ქართველების დიდი ნაწილი დასავლეთს ემხრობა და მოსკოვი წარსულსა თუ აწმყოში არაერთხელ შემოჭრილა უხეშად საქართველოში, ელიავას მოვაჭრეების დიდ ნაწილს რუსეთისა და საბჭოთა კავშირის მიმართ სიმპათიები აქვთ. თუმცა ყველაფერი უფრო რთულადაა.</p> <p>კაპიტალიზმმა და დემოკრატიამ მოიტანა მხოლოდ “ანარქია და სიბინძურე”, -  ჩივის ვაჟა და შეშფოთებულია, რომ საქართველოს ქრისტიანულ-მართლმადიდებლური ტრადიციები “დასავლური იდეების”, საფრთხის ქვეშ არიან, ისეთების როგორიც ლგბტ უფლებებია. მაგრამ სხვა დახლის მფლობელები მოსკოვის წინააღმდეგი სწორედ იმიტომ არიან, რომ კომუნისტები მართლმადიდებელ ეკლესიას დევნიდნენ. დაახლოვება დასავლეთთან, ევროკავშირსა და ნატოში შესვლა, მათი განცხადებით, ახლა ერთადერთი გზაა, საქართველოს იდენტობისა და სუვერენიტეტის უზრუნველსაყოფად.</p> <p>თავიდან მე ვპასუხობდი კითხვებს ჩემ შესახებ. “რომელი სოფლიდან ხარ?” - მკითხეს. თავს ფესვების გარეშე ვგრძნობდი, როცა ვუხსნიდი, როგორ დავიბადე ბრიტანეთის ერთ-ერთ ქალაქში, რომელშიც არასოდეს დავბრუნებულვარ.</p> <p>უფრო დიდი გამოწვევა 360 გრადუსიან ჩარჩოში ადამიანების დახატვა იყო. ვცდილობდი რაც შეიძლება სწრაფად მემუშავა, სანამ მოძრაობას დაიწყებდნენ. ამას კიდევ ერთი ზეწოლა ემატებოდა, ხატვის დასრულებისთანავე მოვაჭრეებს მისი დანახვა შეეძლოთ. ეს იყო პარადოქსი და ხატვის ამაღელვებელი პროცესი. ეს იყო ძალიან ნელი და  ასევე დაუყონებლივიც.</p> <p>ამით ის უფრო მომხიბვლელი გახდა, როცა პანორანა უკვე ფორმას იღებდა, მოვაჭრეები სხვა, შორი ადგილებიდან მოდიოდნენ, რომ მათი მეგობრების გამოსახულება ენახათ და დაეცინათ. “ცუდი არ არის”, - გაიღიმა ერთმა სტუმარმა როცა ჩემს ნახატზე <a href='#' class='to-character' data-id='4'>ედუარდი</a> დაინახა, - “მაგრამ მისი ცხვირი საკმარისად დიდი არ დაგიხატავს.”</p> <p>ხანდახან უთანხმოებებიც იყო, ჩხუბიც. თუ რომელიმე მართლმადიდებლურ დღესასწაულზე მივიდოდი, ისეთებზე როგორიც მარიამობაა, ან ვინმეს დაბადების დღე, მუშაობა უნდა დამევიწყებინა. ისინი მართმევდნენ კალამს და სანაცვლოდ ჭიქას მაძლევდნენ. მართმევდნენ ჩემს კალამს და მის ნაცვლად ღვინოს მაწვდიდნენ ხელში. <a href='#' class='to-character' data-id='9'>ტარიელი</a>, რომლის რუსული ძრავების კოლექციაც ადრე დავხატე, ჩემს ნახატს სათავსოში კეტავდა.</p> <p>მას შემდეგ, რაც მათი სახლში დამზადებული ღვინო ჩემში დაიწყებდა დინებას, სწორ ხაზზე სიარული მიჭირდა, რომ არაფერი ვთქვათ ხატვაზე. ელიავა იმდენადაა კულტურა და საზოგადოება, როგორც ბაზარი.</p> <p>წარსულის გადამუშავებას მომავალი არასდროს ჰქონია, თუმცა ბევრი დახლის მფლობელი ჯერ კიდევ იბრძვის. უფრო მეტ ადამიანს შეუძლია ახალი ტექნიკის ყიდვა, ვიდრე მეორადის გამოყენება. “ეს ბიზნესი ნამდვილად არ არის”, - მითხრა <a href='#' class='to-character' data-id='7'>მირიან ნოზაძემ </a> სევდიანად, როცა საბჭოთა დროინდელ ხრახნებსა და ჭანჭიკებს დახედა, რომლებიც მისი შემოსავლის ძირითადი წყაროა. “ჩვენ უბრალოდ სპეკულანტები ვართ”,  - დაამატა მან, კომუნისტურ ეპოქაში დამკვიდრებული, ბიზნესმენების დამამცირებელი სიტყვის გამოყენებით.</p> <p>მაგრამ ნაცვლად სადგურისა, რომელიც რაღაც უკეთესისკენ მიდის, ელიავას გახდა ბოლო სადგური მრავალი იქ მუშავისთვის - მაშინ, როდესაც მატარებელი რომელსაც საქართველო საბაზრო ეკონომიკისკენ მიყავს ქუხს.</p> <p>“ვინ დაგვაბრუნებს ძველ დროში?”,- ოხრავს <a href='#' class='to-character' data-id='10'>ტასო ცერცვაძე</a>. ისევე როგორც მრავალი ელიავაზე მომუშავე, იგი წარმოშობით ჭიათურიდანაა, სამთო ქალაქიდან დასავლეთ საქართველოში, რომელიც საბჭოთა კავშირის დაშლისა და გარანტირებული ბაზრის დაკარგვის შემდეგ დაზარალდა. ახლა მას ერთი ქალის ბიზნესი აქვს,  ყავა და ჩაი, მითანით.  ის სახლში დაბრუნებას ნატრობს, მაგრამ როგორც ამბობს, - “სიახლეს უნდა გაუმკლავდეს”.</p> <p>“ახალი” კი მუდმივად მოდის. რამდენიმე დახლი დაიხურა სანამ მე ვმუშაობდი და ჩემი ნახატიდან ორმა ადამიანმა დატოვა ბაზარი. ასე რომ, ეს ნამდვილად ისტორიული მასალა.</p> <p>ერთ დღეს ბაზრის ერთ-ერთ მეპატრონესთან, გია ანდრიაძესთან მივედი. ჩვენ მისი ოფისის აივანზე ვისაუბრეთ, მრავალსართულიანი  კომპლექსის პენტჰაუსში, რომელიც მან იმ ადგილას ააშენა, რომელიც მოვაჭრეებმა დატოვეს. მომავალი რუქებზე უკვე დატანილია - ახალი შენობები ყველა მხარიდან ავიწროვებენ ელიავას ორიგინალურ თუნუქის სახურავებს.</p> <p>ამ თუნუქების დიდი ნაწილი ხუთ წელიწადში გაქრება, წინასწარმეტყველებს ის: “ისინი ნოსტალგიას ყიდიან.”</p> <br/><br/> <p>ენდრიუ ნორთი საქართველოში მცხოვრები ბრიტანელი ჟურნალისტია. იპოვეთ ის ტვიტერზე <a href='https://twitter.com/NorthAndrew' target='_blank'>@NorthAndrew</a> და იხილეთ მისი ნამუშევრები: <a href='http://sketchyreports.com/' target='_blank'>sketchyreports.com</a></p>"
  },
  "behind": {
    "name": "კადრს მიღმა",
    ...
    "text": "<div class='credits'>Credits</div> <ul> <li><span>ნახატი:</span> ენდრიუ ნორთი</li> <li><span>სიტყვები და ვიდეო:</span> ენდრიუ ნორთი</li> <li><span>პროდიუსერი:</span> სოფიკო ვასაძე</li> <li><span>დიზაინი:</span> <a href='http://www.jumpstart.ge/ka' target='_blank'>ჯამპსტარტ ჯორჯია</a></li> <li><span>რედაქტორი:</span> ჯასტი ბერკი/Eurasianet</li> <li><span>თარგმანი:</span> სოფიკო ვასაძე, დიმიტრი ბით-სულეიმანი</li> <li> განსაკუთრებული მადლობა ყველას ელიავადან, ვინც პროექტს უჭერდა მხარს: ტარიელ სარალიძე, ჯაბა ნაკაშიძე, გია თოთაძე, მირიან ნოზაძე, ოთარ მუჯირი, თამაზ დუდაშვილი, ტასო ცერცვაძე, კახა, მარინა ესებუა, ვაჟა ჯამაგიძე, ედუარდ მიროიანი, ფრიდონი, პაატა და ცეზარი..</li> <li>რჩევისთვის და მხარდაჭერისთვის დიდი მადლობა ასევე: კოტე სულაბერიძეს, ნინო ჭილაშვილს, ირენა პოპიაშილს, ნატალია ანთელავას.</li> </ul>"
  },
  "stories": {
    "s1": {
